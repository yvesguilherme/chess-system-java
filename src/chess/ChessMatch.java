	...
	private Piece makeMove(Position source, Position target) {
		...
		if (p instanceof Pawn) {
			if (source.getColumn() != target.getColumn() && capturedPiece == null) {
				...
				capturedPieces.add(capturedPiece); // adicionando na lista de peças capturadas
				piecesOnTheBoard.remove(capturedPiece); // removendo a peça captada das peças do tabuleiro
			}
		}
